...
import com.xnjr.mall.dto.req.XN808045Req;
 ...
 * @history:
 */
public class XN808045 extends AProcessor {

    private ICartAO cartAO = SpringContextHolder.getBean(ICartAO.class);

    private XN808045Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN808045Req.class);
