...
public class StorePurchaseDAOImpl extends AMybatisTemplate implements
        IStorePurchaseDAO {
    ...
    public StorePurchase select(StorePurchase condition) {
        return super.select(NAMESPACE.concat("select_storePurchase"),
            condition, StorePurchase.class);
    }

    @Override
    public Long selectTotalCount(StorePurchase condition) {
        return super.selectTotalCount(
            NAMESPACE.concat("select_storePurchase_count"), condition);
    }

    @Override
    public List<StorePurchase> selectList(StorePurchase condition) {
        return super.selectList(NAMESPACE.concat("select_storePurchase"),
            condition, StorePurchase.class);
    }

    @Override
    public List<StorePurchase> selectList(StorePurchase condition, int start,
            int count) {
        return super.selectList(NAMESPACE.concat("select_storePurchase"),
            start, count, condition, StorePurchase.class);
    }
