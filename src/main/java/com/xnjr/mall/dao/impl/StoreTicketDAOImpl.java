...
public class StoreTicketDAOImpl extends AMybatisTemplate implements
        IStoreTicketDAO {
    ...
    public Long selectTotalCount(StoreTicket condition) {
        return super.selectTotalCount(
            NAMESPACE.concat("select_storeTicket_count"), condition);
    }

    @Override
    public List<StoreTicket> selectList(StoreTicket condition) {
        return super.selectList(NAMESPACE.concat("select_storeTicket"),
            condition, StoreTicket.class);
    }

    @Override
    public List<StoreTicket> selectList(StoreTicket condition, int start,
            int count) {
